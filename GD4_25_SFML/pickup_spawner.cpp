...
PickupSpawner::PickupSpawner(float x, float y, int width, int height, bool auto_spawn, Physics* physics_ptr, std::default_random_engine& rand, SoundPlayer* sounds, TextureHolder* texture_holder) :
	SceneNode(ReceiverCategories::kPickupSpawner),
	m_width(width),
	m_height(height),
	m_auto_spawn(auto_spawn),
